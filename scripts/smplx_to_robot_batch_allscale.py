...
import math
import numpy as np
from general_motion_retargeting import GeneralMotionRetargeting_allscale as GMR
...
#运行指令:
# python scripts/smplx_to_robot_batch_allscale.py --csv_file ../data/locomotion/manifest_raw.csv --batch_save_path ../data/locomotion/robot/ik_based_scale/pkl/   --robot unitree_g1 --no_visualize --num_threads 3
